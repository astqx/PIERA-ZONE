...
def cpyrc(): #Copyright badge
    webbrowser.open("https://www.copyrighted.com/work/EFZ2gSXGdJZWjYaG")
#__Main GUI__
initial = Tk()
...
crimg = Image.open (os.path.join(data_dir, "Copyright Badge.png"))
crimg = crimg.resize((52, 31), Image.ANTIALIAS)
copyright_badge = ImageTk.PhotoImage(crimg)
cyp = Button(initial, image = copyright_badge, command = cpyrc, borderwidth = 0)
