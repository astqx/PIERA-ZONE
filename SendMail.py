...
def Send_response(res_email): #Send mail of the response to the teacher
    ...
    with open(os.path.join(res_dir,filename), "rb") as attachment:
...
root_dir = os.path.join(os.getcwd(),'Program Files', 'Cache')
res_dir = os.path.join(os.getcwd(), 'Student Responses')
